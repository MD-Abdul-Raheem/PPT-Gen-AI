...
import { Download, Sparkles, RefreshCw, Presentation, Layout, Play, X, ChevronLeft, ChevronRight, Image as ImageIcon } from 'lucide-react';
...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col font-sans text-slate-900 bg-surface-50">
        ...
        <div className="max-w-[1600px] mx-auto px-6 h-18 flex items-center justify-between py-4">
          ...
          <div className="flex items-center gap-4">
             {presentation && (
                 <button 
                    onClick={resetApp}
                    className="text-sm font-medium text-slate-500 hover:text-slate-800 transition-colors px-3 py-2 rounded-lg hover:bg-slate-100"
                >
                    New Project
                </button>
             )}
      ...
      <main className="flex-1 max-w-[1600px] w-full mx-auto px-4 sm:px-6 py-8 grid grid-cols-1 lg:grid-cols-12 gap-8 h-[calc(100vh-80px)] min-h-[800px]">
        
        <div className="lg:col-span-4 xl:col-span-3 flex flex-col gap-6 order-1 h-full overflow-hidden">
        ...
        <div className="lg:col-span-8 xl:col-span-9 flex flex-col order-2 h-full min-h-[500px]">
      ...
      {isPlaying && presentation && (
          <div className="fixed inset-0 z-[100] bg-black text-white flex flex-col">
              ...
              <div className="flex-1 flex items-center justify-center p-8 relative">
                  ...
                  <div 
                      className="w-full max-w-6xl aspect-video bg-white text-slate-900 shadow-2xl rounded-xl overflow-hidden relative flex flex-col p-8 sm:p-16 animate-in zoom-in-95 duration-300"
                      style={{
                  ...
                  >
                        ...
                        <div className="mb-10 flex justify-between items-start">
                             <h2 
                                className="text-4xl sm:text-5xl font-bold max-w-4xl leading-tight"
                                style={{ 
                             ...
                             <div className="flex-1 overflow-y-auto pr-4">
                                <ul className="space-y-6">
                                    {presentation.slides[playSlideIndex].content.map((point, idx) => (
                                        <li key={idx} className="flex items-start gap-4 text-2xl sm:text-3xl leading-relaxed">
                        ...
                        <div className="absolute bottom-8 right-8 text-xl opacity-50">
              ...
              <div className="h-16 bg-zinc-900 flex items-center justify-center text-sm text-zinc-500 gap-8">
